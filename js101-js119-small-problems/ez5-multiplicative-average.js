...
function numsProduct(numsArray) {
  return numsArray.reduce((acc, cv) => acc * cv, 1);
}

function multiplicativeAverage(numsArray) {
  return (numsProduct(numsArray) / numsArray.length).toFixed(3);
}
